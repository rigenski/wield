        ...
        <main className="h-screen w-full relative">
            <div className="flex flex-col w-full h-full border justify-center items-center gap-20">
                ...
                <div className="flex w-3/4 gap-4 items-center">
                    <div className="flex-1 h-3/4 py-4 px-4 flex flex-col gap-2 border justify-center border-[#ED3D3D] bg-[#700C11]/50 rounded-lg">
                    ...
                    <div className="flex-1 h-full py-4 px-4 flex flex-col gap-2 border justify-center border-[#ED3D3D] bg-[#700C11]/50 rounded-lg">
                        <div className="flex  flex-col gap-1 items-start">
